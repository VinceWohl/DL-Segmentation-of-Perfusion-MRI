...
class BaselineCrossAttentionLoss(nn.Module):
    """
    Baseline loss with only BCE and Dice loss for CrossAttention baseline comparison.
    """
...
class nnUNetTrainer_SeparateDecoders_CrossAttention(nnUNetTrainer):
    """
    Baseline Separate Decoders trainer with cross-hemisphere attention and BCE + Dice loss.
    Combines information sharing through attention with hemisphere specialization.
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, 
        ...
        print("Baseline Separate Decoders with Cross-Hemisphere Attention + BCE + Dice Loss")
    ...
    def _build_loss(self):
        ...
        loss = BaselineCrossAttentionLoss(
            bce_kwargs={},
            soft_dice_kwargs={
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if validation_results:
            ...
            print("\n" + "="*60)
            print("FINAL VALIDATION RESULTS - CROSS-HEMISPHERE ATTENTION")
            print("="*60)
    ...
    def _save_validation_summary(self, validation_results, validation_folder):
        ...
        if validation_results:
            ...
            summary = {
                "experiment_info": {
                    "trainer": "nnUNetTrainer_SeparateDecoders_CrossAttention",
                    "dataset": "Dataset001_PerfusionTerritories",
                    "configuration": "2d",
                    "fold": self.fold,
                    "num_epochs": self.num_epochs,
                    "loss_type": "baseline_bce_dice_crossattention",
