...
class CrossAttentionSpatialComplementaryLoss(nn.Module):
    """
    Enhanced loss with spatial consistency and complementary loss for Cross-Attention trainer.
...
class nnUNetTrainer_SeparateDecoders_CrossAttention_SpatialLoss_ComplementaryLoss(nnUNetTrainer):
    """
    Enhanced Separate Decoders trainer with cross-hemisphere attention, spatial consistency loss, and complementary loss.
    Combines cross-attention information sharing, hemisphere specialization, spatial regularization, and complementary constraints.
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, 
        ...
        print("Enhanced Separate Decoders with Cross-Hemisphere Attention + Spatial + Complementary Loss")
    ...
    def _build_loss(self):
        """Build enhanced loss function with spatial consistency and complementary loss."""
        loss = CrossAttentionSpatialComplementaryLoss(
            bce_kwargs={},
            soft_dice_kwargs={
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if validation_results:
            ...
            print("\n" + "="*60)
            print("FINAL VALIDATION RESULTS - CROSS-ATTENTION + SPATIAL + COMPLEMENTARY LOSS")
            print("="*60)
    ...
    def _save_validation_summary(self, validation_results, validation_folder):
        ...
        if validation_results:
            ...
            summary = {
                "experiment_info": {
                    "trainer": "nnUNetTrainer_SeparateDecoders_CrossAttention_SpatialLoss_ComplementaryLoss",
                    "dataset": "Dataset001_PerfusionTerritories",
                    "configuration": "2d",
                    "fold": self.fold,
                    "num_epochs": self.num_epochs,
                    "loss_type": "bce_dice_crossattention_spatial_complementary",
