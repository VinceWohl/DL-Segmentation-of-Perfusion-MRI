...
class SpatialComplementarySeparateDecodersLoss(nn.Module):
    """
    SeparateDecoders loss with both spatial and complementary enhancements.
    Combines BCE + Dice + Spatial consistency + Complementary loss for balanced hemisphere learning.
    """
...
class nnUNetTrainer_SeparateDecoders_SpatialLoss_ComplementaryLoss(nnUNetTrainer):
    """
    Trainer with separate decoders and both spatial and complementary loss enhancements.
    Uses dedicated decoders for each hemisphere with spatial smoothness and complementary constraints.
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, 
        ...
        print("Separate Decoders with Spatial + Complementary Loss Enhancement")
    ...
    def _build_loss(self):
        ...
        loss = SpatialComplementarySeparateDecodersLoss(
            bce_kwargs={},
            soft_dice_kwargs={
    ...
    def _save_validation_summary(self, validation_results, validation_folder):
        ...
        if validation_results:
            ...
            summary = {
                "experiment_info": {
                    "trainer": "nnUNetTrainer_SeparateDecoders_SpatialLoss_ComplementaryLoss",
