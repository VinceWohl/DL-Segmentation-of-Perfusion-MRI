...
class CrossAttentionSpatialLoss(nn.Module):
    """
    Enhanced loss with spatial consistency for Cross-Attention trainer.
    ...
    def forward(self, net_output: torch.Tensor, target: torch.Tensor):
        ...
        total_loss = base_loss + self.spatial_weight * spatial_loss
        
        return total_loss


class nnUNetTrainer_SeparateDecoders_CrossAttention_SpatialLoss(nnUNetTrainer):
    """
    Enhanced Separate Decoders trainer with cross-hemisphere attention and spatial consistency loss.
    Combines cross-attention information sharing, hemisphere specialization, and spatial regularization.
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, 
        ...
        print("Enhanced Separate Decoders with Cross-Hemisphere Attention + Spatial Loss")
    ...
    def _build_loss(self):
        ...
        loss = CrossAttentionSpatialLoss(
            bce_kwargs={},
            soft_dice_kwargs={
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if validation_results:
            ...
            print("\n" + "="*60)
            print("FINAL VALIDATION RESULTS - CROSS-ATTENTION + SPATIAL LOSS")
            print("="*60)
    ...
    def _save_validation_summary(self, validation_results, validation_folder):
        ...
        if validation_results:
            ...
            summary = {
                "experiment_info": {
                    "trainer": "nnUNetTrainer_SeparateDecoders_CrossAttention_SpatialLoss",
                    "dataset": "Dataset001_PerfusionTerritories",
                    "configuration": "2d",
                    "fold": self.fold,
                    "num_epochs": self.num_epochs,
                    "loss_type": "bce_dice_crossattention_spatial",
